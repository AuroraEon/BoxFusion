...
class RuntimeInstrumentation:
    ...
    FRAME_FIELDNAMES = [
        ...
        "data_preprocess_sec",
        "preinfer_total_sec",
        "preinfer_sample_unpack_sec",
        "preinfer_gt_pointcloud_prep_sec",
        "preinfer_augmentor_package_sec",
        "preinfer_augmentor_sensor_info_deepcopy_sec",
        "preinfer_augmentor_measurement_wrap_sec",
        "preinfer_device_move_sec",
        "preinfer_preprocess_total_sec",
        "preinfer_preprocess_normalize_sec",
        "preinfer_preprocess_depth_normalize_sec",
        "preinfer_preprocess_image_normalize_sec",
        "preinfer_preprocess_batch_sec",
        "preinfer_preprocess_image_batch_sec",
        "preinfer_preprocess_depth_batch_sec",
        "preinfer_accounted_sum_sec",
        "preinfer_unaccounted_remainder_sec",

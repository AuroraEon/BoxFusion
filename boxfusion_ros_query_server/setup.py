...
setup(
    ...
    data_files=[
        ...
        ("share/boxfusion_ros_query_server/launch", ["launch/artifact_marker_publisher.launch.py"]),
    ...
    entry_points={
        "console_scripts": [
            ...
            "boxfusion_artifact_marker_publisher = boxfusion.ros_artifact_marker_publisher:main",
        ],
    },
)

...
Created: `2026-05-14T08:34:10.759833+00:00`

Dataplane ready: `True`

## Topics

- `/clock`: publishers=1 subscribers=21 messages=249 rate_hz=9.947
- `/odom`: publishers=1 subscribers=2 messages=736 rate_hz=29.399
- `/scan`: publishers=1 subscribers=4 messages=124 rate_hz=4.993
- `/tf`: publishers=2 subscribers=7 messages=1221 rate_hz=48.874
- `/tf_static`: publishers=2 subscribers=7 messages=500 rate_hz=20.04

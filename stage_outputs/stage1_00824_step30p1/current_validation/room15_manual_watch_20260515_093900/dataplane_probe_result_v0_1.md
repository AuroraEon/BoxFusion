...
Created: `2026-05-15T01:40:08.203756+00:00`

Dataplane ready: `True`

## Topics

- `/clock`: publishers=1 subscribers=21 messages=250 rate_hz=9.965
- `/odom`: publishers=1 subscribers=2 messages=736 rate_hz=29.379
- `/scan`: publishers=1 subscribers=4 messages=125 rate_hz=4.992
- `/tf`: publishers=2 subscribers=7 messages=1221 rate_hz=48.831
- `/tf_static`: publishers=2 subscribers=7 messages=503 rate_hz=20.086

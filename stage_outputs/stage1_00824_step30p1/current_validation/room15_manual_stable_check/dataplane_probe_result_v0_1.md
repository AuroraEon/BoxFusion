...
Created: `2026-05-14T11:58:24.736772+00:00`

Dataplane ready: `True`

## Topics

- `/clock`: publishers=1 subscribers=21 messages=249 rate_hz=9.953
- `/odom`: publishers=1 subscribers=2 messages=736 rate_hz=29.39
- `/scan`: publishers=1 subscribers=4 messages=125 rate_hz=4.993
- `/tf`: publishers=2 subscribers=7 messages=1221 rate_hz=48.856
- `/tf_static`: publishers=2 subscribers=7 messages=502 rate_hz=20.076

...
Created: `2026-05-14T03:38:44.148818+00:00`

Dataplane ready: `True`

## Topics

- `/clock`: publishers=1 subscribers=21 messages=249 rate_hz=9.951
- `/odom`: publishers=1 subscribers=2 messages=736 rate_hz=29.388
- `/scan`: publishers=1 subscribers=4 messages=125 rate_hz=4.994
- `/tf`: publishers=2 subscribers=7 messages=1221 rate_hz=48.845
- `/tf_static`: publishers=2 subscribers=7 messages=501 rate_hz=20.04

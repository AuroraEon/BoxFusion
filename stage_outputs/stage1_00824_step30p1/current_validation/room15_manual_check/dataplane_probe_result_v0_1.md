...
Created: `2026-05-14T07:21:57.815986+00:00`

Dataplane ready: `True`

## Topics

- `/clock`: publishers=1 subscribers=21 messages=249 rate_hz=9.954
- `/odom`: publishers=1 subscribers=2 messages=735 rate_hz=29.37
- `/scan`: publishers=1 subscribers=4 messages=125 rate_hz=4.993
- `/tf`: publishers=2 subscribers=7 messages=1221 rate_hz=48.991

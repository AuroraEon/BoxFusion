...
Created: `2026-05-14T07:13:07.798926+00:00`

Dataplane ready: `True`

## Topics

- `/clock`: publishers=1 subscribers=21 messages=250 rate_hz=9.953
- `/odom`: publishers=1 subscribers=2 messages=736 rate_hz=29.407
- `/scan`: publishers=1 subscribers=4 messages=125 rate_hz=4.994
- `/tf`: publishers=2 subscribers=7 messages=1223 rate_hz=48.89
- `/tf_static`: publishers=2 subscribers=7 messages=503 rate_hz=20.097
